...
const NAV = [
  ...
  { id: "app", ko: "AI 앱·서비스", en: "AI Apps & Services", icon: "spark", group: "AI 밸류체인" },
  { id: "model", ko: "파운데이션 모델", en: "Foundation Models", icon: "ai", group: "AI 밸류체인" },
  { id: "data", ko: "데이터·개발 툴링", en: "Data & Tooling", icon: "grid", group: "AI 밸류체인" },
  { id: "infra", ko: "AI 인프라·클라우드", en: "Infra & Cloud", icon: "server", group: "AI 밸류체인" },
