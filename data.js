...
window.DASH = (function () {
  ...
  const ARTICLES = [
    ...
    { date: "2026-06-25", co: "OpenAI", cat: "native", source: "NYT / Reuters", title: "OpenAI IPO 2027년으로 연기 검토 — Kalshi 예측시장 발표 확률 59%", summary: "· NYT 보도: OpenAI IPO를 2026년 말 → 2027년으로 연기 검토\n· SpaceX 상장 후 기술주 시장 변동성 확대가 주요 배경\n· Altman: '$1T 평가액 이하로 낮추는 것은 받아들일 수 없다'\n· Kalshi 예측시장: 2027.03.01 이전 IPO 발표 확률 59% 평가", tag: "IPO", url: "https://www.nytimes.com" },
