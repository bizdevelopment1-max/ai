...
window.DASH = (function () {
  ...
  const COMPANIES = [
    ...
    },
    {
      ...
      funding: "$3.5B 라운드(클로즈)", trend: 71, trendBasis: "밸류 €11.7B→$20B · ARR 20배↑",
      note: "프랑스 기반 AI 스타트업. 2026.06 신규 $3.5B 라운드를 밸류 $20B로 클로즈(직전 €11.7B 대비 약 2배) — 유럽 최고가 사기업 중 하나. ARR $400M+(2026.02, 전년比 20배)·연말 $1B ARR 목표. 2026.03 $830M 부채로 파리 데이터센터(NVIDIA 칩 13,800개) 구축. Le Chat·Mistral Large. 유럽 AI 주권의 상징.",
  ...
  const QA_PAIRS = [
    ...
    { q: "가장 빠르게 성장하는 AI 스타트업은?", a: "2026년 가장 큰 변화는 '수평적 LLM'에서 '수직적 전문 AI'로의 중심 이동입니다. 주요 기업: ElevenLabs(음성 합성, 밸류 $11B, 160개국 3M+ 크리에이터), Harvey(AI 법률, $11B, Allen & Overy 등 글로벌 로펌), Sierra(AI 고객서비스, $10B, ARR 배수 67x로 최고 수준), Glean(기업 지식 검색, $7.2B, Fortune 500 200+ 고객), Databricks(데이터+AI, $134B, ARR $3B+), Mistral(유럽 최대, $20B·ARR $400M+, 오픈소스 전략). 투자 패턴 변화: 2023~24년엔 'GPT를 업종에 적용한다'만으로 투자가 쏟아졌지만, 2026년엔 '실제 ARR과 고객 ROI 증명' 없이는 후속 투자가 어렵습니다. Sierra의 67x ARR 배수는 고객 서비스 비용을 60~80% 절감한다는 구체적 데이터가 뒷받침합니다.", nav: "startup", keywords: ["스타트업", "성장", "빠른", "버티컬", "elevenlabs", "harvey", "sierra"] },
