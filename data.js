...
window.DASH = (function () {
  ...
  const COMPANIES = [
    // ── native ──
    {
      ...
      valuation: "$852B", valAsof: "2026-03-31 공식", metric: "월 매출(보도)", value: "~$2B", metricAsof: "2026-02",
      funding: "$122B 라운드(2026-03-31 공식 종결)", trend: 0, trendBasis: "S-1 기밀 제출 · 공모 시점 미정",
      metricTiming: { announcedAt: "2026-03-31", metricObservedAt: "2026-03-31", observedWindow: "공식 종결일 03-31 · 03-30 표기는 독립 확인 전 참고 메모", lastVerifiedAt: "2026-08-15" },
      ...
      sources: [
        { tier: "official", label: "조달 $122B · $852B post-money · 공식 종결일", asOf: "2026-03-31", url: "https://openai.com/index/accelerating-the-next-phase-ai/" },
    ...
    },
    {
      ...
      valuation: "$965B", valAsof: "2026-05-28 발표", metric: "run-rate 매출(회사 발표)", value: "$47B", metricAsof: "2026-05 상순 · 정확한 일자 미공개",
      funding: "Series H $65B(2026-05-28)", trend: 0, trendBasis: "공식 $47B · 3자 추정 $69B(2026-07-10)",
      metricTiming: { announcedAt: "2026-05-28", metricObservedAt: "2026-05", observedWindow: "회사 표현 'earlier this month' · 05-07은 미확인 2차 추정", lastVerifiedAt: "2026-08-15" },
    ...
    },
    {
      ...
      valuation: "$3.5T", valAsof: "26.06", metric: "AI 런레이트", value: "$37B", metricAsof: "FY26 Q3 · 2026-04-29 발표",
      funding: "상장 (MSFT)", trend: 123, trendBasis: "AI 부문 +123% YoY",
      metricTiming: { announcedAt: "2026-04-29", metricObservedAt: "FY2026 Q3", observedWindow: "quarter-end disclosure", lastVerifiedAt: "2026-08-15" },
  ...
  const MOBILE_STRATEGY = {
    ...
    workloadMap: [
      ...
      { no: "06", workload: "Trust & Financial Safety", shift: "통화·메시지·화면공유·영상회의에서 사기와 딥페이크를 실시간 차단", bottleneck: "오탐 책임·지역 언어·전력·금융사 데이터 경계", platform: "Samsung Phone + Knox + NPU 탐지 + 금융사 risk API", opportunity: "기업 보안 좌석·금융권 B2B2C 라이선스", proof: "피해 회피액·FPR·기업 좌석·은행 API attach" },
      { no: "07", workload: "Clinical Health", shift: "wellness insight에서 임상 검증·보험자·고용주 계약으로 확장", bottleneck: "의료기기 해당성·임상 근거·수가·책임", platform: "Watch/Ring sensors + Health + Knox data boundary", opportunity: "임상 AI 라이선스·보험 reimbursement·기업 건강 계약", proof: "임상 endpoint·covered lives·90일 유지·cost avoided" },
      { no: "08", workload: "AI Companion", shift: "소셜·데이팅을 넘어선 장시간 대화와 개인화", bottleneck: "상위 앱 집중·청소년 안전·관계 종속·높은 추론 원가", platform: "Store·Wallet·NPU·carrier distribution + safety controls", opportunity: "상위 앱 선탑재·결제 수수료·기업 복지 번들", proof: "WAU hours·paid attach·revenue share·safety incident" },
      { no: "09", workload: "Foldable Offline AI", shift: "큰 화면과 로컬 처리를 결합한 오프라인 생산성", bottleneck: "기능별 cloud 의존성·발열·메모리·유료 가치", platform: "Z Fold + One UI Multi Window + NPU + Knox", opportunity: "오프라인 생산성 Suite·기업 좌석", proof: "offline 완료율·분당 절감시간·paid attach·Wh/task" },
      { no: "10", workload: "Satellite AI Continuity", shift: "긴급 통신을 넘어 단절 구간의 AI 상태·작업 연속성", bottleneck: "통신사별 지원·지연·데이터 allowance·배터리", platform: "Direct-to-Cell + local SLM + carrier billing", opportunity: "통신사 공동 과금형 always-connected AI", proof: "satellite attach·KB/task·완료율·revenue share" },
    ],
    opportunityPortfolio: [
      ...
      { id: "clinical-health-ai", horizon: "H2 · HEALTH", title: "Clinical & Payer Health AI", customer: "보험자·고용주·의료 파트너·만성질환 사용자", thesis: "wellness 구독을 임상 근거·의료기기 분류·보험자/고용주 배포로 연결하면 더 큰 반복 매출 경로를 만들 수 있음", offer: "센서 기반 임상 AI·activation license·outcome contract", gate: "규제 분류·임상 endpoint·수가·covered lives·ROI", ownAssets: ["Galaxy Watch·Ring", "Samsung Health", "Knox 데이터 경계", "글로벌 기기 fleet"], nextMetrics: [{ label: "소비자 mix 45/25/20", value: "원문 미확인 · 게시 보류", status: "withheld" }, { label: "임상 근거", value: "기능별 protocol 필요", status: "baseline-required" }, { label: "보험/기업 계약", value: "covered lives·activation·갱신", status: "model-ready" }], score: "Validate" },
      { id: "companion-distribution", horizon: "H2 · DISTRIBUTION", title: "AI Companion Distribution", customer: "상위 companion 사업자·통신사·소비자", thesis: "사용시간은 크지만 매출은 상위 소수에 집중되므로 자체 앱보다 온디바이스 최적화·선탑재·결제 유통으로 진입", offer: "파트너 선탑재·구독 결제·carrier bundle·기업 복지 채널", gate: "WAU hours·paid attach·파트너 집중·청소년 안전·해지/이전", ownAssets: ["Galaxy Store", "Samsung Wallet", "온디바이스 NPU", "통신사 채널", "Knox 권한"], nextMetrics: [{ label: "US attention", value: "705M vs 280M hours · Q1 합계", status: "reported-benchmark" }, { label: "모바일 매출", value: "$150M · 2026 Q1", status: "official-benchmark" }, { label: "매출 집중", value: "Top 10% = 89%", status: "reported-benchmark" }], score: "Partner first" },
      { id: "foldable-offline-productivity", horizon: "H1 · FORM FACTOR", title: "Foldable Offline AI Productivity", customer: "프로 사용자·현장 인력·보안 기업", thesis: "Z Fold의 큰 화면과 NPU를 결합해 번역·편집·문서 과업을 연결이 끊겨도 완결하면 폴더블 가격 프리미엄을 반복 매출로 확장 가능", offer: "offline 생산성 Suite·Knox 기업 좌석", gate: "기능별 로컬 처리 공개·발열·메모리·유료 전환", ownAssets: ["Galaxy Z Fold", "One UI Multi Window", "Galaxy NPU", "Knox", "S Pen workflow"], nextMetrics: [{ label: "공식 제품 근거", value: "Z Fold7 on-device translation·Generative Edit", status: "official-benchmark" }, { label: "오프라인 완료율", value: "기능별 실기기 baseline 필요", status: "baseline-required" }, { label: "기업 PoC", value: "현장 업무 2개 과업", status: "proposal" }], score: "Build PoC" },
      { id: "satellite-ai-continuity", horizon: "H2 · CONNECTIVITY", title: "Satellite Always-connected AI", customer: "오프로드 사용자·현장 기업·통신사", thesis: "위성 text/data 확대를 로컬 SLM의 최소 동기화 백본으로 사용하면 셀룰러 단절 구간에도 에이전트 상태와 핵심 작업을 유지 가능", offer: "통신사 공동 과금형 AI continuity add-on", gate: "모델·지역별 지원·KB/task·지연·배터리·책임", ownAssets: ["Galaxy modem/RF", "One UI", "온디바이스 SLM", "통신사 채널", "Knox"], nextMetrics: [{ label: "공식 파트너 범위", value: "T-Mobile·Verizon·VMO2·KDDI", status: "official-benchmark" }, { label: "유료 AI 상품", value: "공개 계약 없음", status: "proposal" }, { label: "통신 원가", value: "KB/task·attach rate baseline 필요", status: "baseline-required" }], score: "Partner PoC" },
    ],
    expertSignals: [
