...
window.DASH = (function () {
  ...
  const ARTICLES = [
    ...
    { date: "2026-06-25", co: "OpenAI", cat: "native", source: "NYT / Reuters", pub: "2026-06-25", title: "OpenAI IPO 2027년으로 연기 검토 — Kalshi 예측시장 발표 확률 59%", summary: "· NYT 보도: OpenAI IPO를 2026년 말 → 2027년으로 연기 검토\n· SpaceX 상장 후 기술주 시장 변동성 확대가 주요 배경\n· Altman: '$1T 평가액 이하로 낮추는 것은 받아들일 수 없다'\n· Kalshi 예측시장: 03.01 이전 IPO 발표 확률 59% 평가", tag: "IPO", url: "https://www.nytimes.com" },
    ...
    { date: "2026-04-29", co: "Microsoft", cat: "bigtech", source: "Microsoft IR / UC Today", title: "Microsoft Q3 FY2026 — AI 연 매출 $37B 런레이트, Azure 40% 재가속", summary: "· Nadella 확인 — AI 사업 연 매출 런레이트 $37B(+123% YoY)\n· M365 Copilot 유료 좌석 2,000만(+250%)·Azure 40% 재가속·전체 매출 $82.9B(+18%)\n· Accenture 74만 좌석 최대 고객 — 기존 번들 락인이 수익화 핵심", tag: "Earnings", url: "https://www.uctoday.com/unified-communications/microsoft-earnings-2026-ai-copilot-enterprise/" },
