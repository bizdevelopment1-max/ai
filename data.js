...
window.DASH = (function () {
  ...
  const COMPANIES = [
    ...
    },
    {
      ...
      funding: "SpaceX 인수 합의", trend: 100, trendBasis: "밸류 $29.3B→$60B · ARR $2B+",
      note: "AI 코딩 에이전트(Anysphere). 2026.06.16 SpaceX가 $60B 전액 주식 인수 합의(3분기 클로징 예정). 창업 3년 만에 ARR $2B+, 기업 고객 60%(Stripe·Adobe·NVIDIA). 코드베이스 전체 이해·버그 수정·리팩토링 자동화로 개발 워크플로우 깊이 침투.",
      vp: "IDE에 깊이 통합된 코딩 에이전트 — 단순 자동완성을 넘어 코드베이스 단위 작업.",
      direction: "SpaceX·xAI 생태계 편입 후 Grok 연계·엔터프라이즈 확장.",
      sources: ["SpaceX $60B 인수 합의 (CNBC '26.06.16)", "ARR $2B+·기업고객 60%", "밸류 $29.3B→$60B"],
  ...
  const ARTICLES = [
    // ── AI Native ──
    { date: "2026-06-19", co: "Anthropic", cat: "native", source: "Bloomberg / TechCrunch", title: "노벨화학상 John Jumper, DeepMind 떠나 Anthropic行 — 과학 AI 인재 이동", summary: "· 2026.06.19 Bloomberg — AlphaFold(2024 노벨화학상) John Jumper, Google DeepMind→Anthropic 이적\n· 연말까지 인수인계 후 합류 · 같은 주 Gemini 공동리드 Noam Shazeer는 OpenAI行\n· Anthropic은 2026년 AI-for-science 인프라(웻랩·Allen Institute·HHMI) 구축 중\n· 최정상 과학 AI 인재가 모델 개발사로 집중되는 트렌드 — Google 인재 유출 가속", tag: "People", url: "https://www.bloomberg.com/news/articles/2026-06-19/nobel-winner-john-jumper-to-leave-google-deepmind-for-anthropic" },
    { date: "2026-06-16", co: "OpenAI", cat: "native", source: "TechCrunch / Fast Company", title: "ChatGPT 점유율 첫 50% 이하 — Gemini·Claude 약진, '3파전' 고착", summary: "· 2026.05 ChatGPT AI 어시스턴트 점유율 46.4%(2025.12 52.8%·2024.12 65.3%서 하락)\n· Gemini 27.7%·Claude 10.3%로 확대 — Claude는 반년 새 약 4배 급증\n· 단 ChatGPT MAU는 11.1억으로 1위 유지(점유율↓ vs 절대 사용자↑ 분리)\n· AI 플랫폼 경쟁이 OpenAI·Google·Anthropic '3파전'으로 굳어짐", tag: "Market", url: "https://techcrunch.com/2026/06/16/chatgpts-market-share-slips-below-50-for-first-time/" },
    { date: "2026-06-10", co: "OpenAI", cat: "native", source: "AP / Axios", title: "Visa, ChatGPT에 결제망 직접 연동 — AI 에이전트가 대신 쇼핑·결제", summary: "· 2026.06.10 Visa Payments Forum 발표 — Visa 결제망을 ChatGPT에 내장\n· 카드 연결 시 AI 에이전트가 Visa 가맹점서 상품 추천→결제까지 대행\n· 가드레일: 지출한도·승인단계·승인 가맹점 · 초기엔 건별 승인(휴먼인더루프)\n· Agentic AI가 실거래(커머스)로 본격 진입한 첫 주요 사례", tag: "Product", url: "https://www.axios.com/2026/06/10/visa-chatgpt-agents-commerce" },
    ...
    { date: "2026-06-17", co: "Anthropic", cat: "native", source: "Anthropic / The Information", title: "Anthropic, IPO 기밀 제출 + 서울 오피스 개설 — 한국 AI 생태계 파트너십", summary: "· 2026.06.01 밸류 $965B로 IPO 기밀 제출 — AI 최대어 상장 경쟁 가세\n· 06.17 서울 오피스 개설 + 한국 AI 생태계 파트너십 발표\n· 단말·제조 등 한국 산업 적용 확대 신호\n· OpenAI(2026.09 목표)와 상장 레이스 본격화", tag: "IPO", url: "https://www.anthropic.com/news" },
    { date: "2026-06-12", co: "SpaceX (xAI, Cursor)", cat: "native", source: "CNBC / TechCrunch", title: "SpaceX, SPCX로 나스닥 데뷔 — 공모가 $135·$75B 조달 '사상 최대 IPO'", summary: "· 2026.06.12 나스닥 상장(티커 SPCX) — 공모가 $135, $75B 조달로 역대 최대 IPO\n· 첫날 +19% $161 마감 · 시총 $2.1T 돌파\n· 4일 뒤 06.16 Cursor(Anysphere) $60B 전액 주식 인수 합의(3분기 클로징 예정)\n· xAI(Grok)는 머스크가 'AI는 처음에 잘못 지어졌다' 자평 — 거버넌스 리스크 병존", tag: "IPO", url: "https://www.cnbc.com/2026/06/16/spacex-spcx-cursor-acquisition-ipo.html" },

    // ── Big Tech AI ──
    { date: "2026-06-08", co: "Apple", cat: "bigtech", source: "Fortune / CNBC / Apple", title: "Apple WWDC 2026 — 'Gemini 탑재 Siri' + 멀티 AI 확장으로 Claude도 아이폰 선택지", summary: "· Siri를 외부 프런티어 모델로 구동 — Gemini 기반 'Siri AI' 공개\n· 멀티 AI Extensions로 Claude를 아이폰 기본 선택지로 최초 편입(모델 선택 개방)\n· 자체 온디바이스 Foundation Models는 유지 + Private Cloud Compute 무기명 처리\n· iOS 27 Beta 1 동시 공개 — 단말 기본 비서의 '모델 개방' 전환점", tag: "Product", url: "https://www.apple.com/apple-intelligence/" },
    ...
    { date: "2026-06-11", co: "Mistral AI", cat: "startup", source: "Bloomberg / TechCrunch", title: "Mistral AI, $3.5B 라운드 클로즈 — 밸류 $20B, 유럽 최고가 사기업", summary: "· 신규 $3.5B 라운드를 밸류 $20B로 클로즈(직전 $12.8B(€11.7B) 대비 약 2배)\n· ARR $400M+(2026.02, 전년比 20배) · 연말 $1B ARR 목표\n· 2026.03 $830M 부채로 파리 데이터센터(NVIDIA 칩 13,800개) 구축\n· EU AI 자주권 기업으로 정부·기업 수요 지속 증가", tag: "Funding", url: "https://thenextweb.com/news/mistral-ai-830m-debt-data-centre-paris" },
  ...
  const INSIGHTS = [
    ...
    { title: "AI 상장 슈퍼사이클 — SpaceX·OpenAI·Anthropic 동시 IPO 레이스", desc: "SpaceX가 2026.06.12 SPCX로 사상 최대 $75B 조달·시총 $2.1T 데뷔, 4일 뒤 Cursor를 $60B에 인수. OpenAI($852B·9월 목표)·Anthropic($965B·기밀 제출)도 상장 가세 — AI 자본이 사모에서 공모로 이동하며 밸류 검증 국면 진입", icon: "report", src: "CNBC/TechCrunch '26.06, Reuters" },
