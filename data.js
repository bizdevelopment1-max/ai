...
window.DASH = (function () {
  ...
  const COMPANIES = [
    ...
    },
    {
      ...
      note: "텍스트→음악 생성 선도. 2026.06.03 Series D $400M·밸류 $5.4B(Bond Capital 주도) — 2025.11 $2.45B서 2배 급등. 구독자 2M+·ARR $300M. 가사·장르만 입력하면 완성곡 생성. WMG는 2025.11 합의·라이선스 파트너십, UMG·Sony는 저작권 소송 진행 중.",
