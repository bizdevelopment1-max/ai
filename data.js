...
window.DASH = (function () {
  ...
  const QA_PAIRS = [
    ...
    { q: "OpenAI의 현재 밸류와 IPO 전망은?", a: "OpenAI의 밸류는 지난 2년간 $29B(2023.01) → $157B(2024.10) → $340B(2025.03) → $730B(2026.02) → $852B(2026.03)으로 수직 상승했습니다. 어떤 사기업도 경험하지 못한 속도입니다. 현재 핵심 지표: 주간 활성 사용자 900M+, 연환산 매출 $25B+(2026.02, 회사·Reuters 공식 확인), 누적 조달 총액 $122B(SoftBank·Amazon·Nvidia·a16z 등). IPO 시나리오: 2026.06.08 SEC에 S-1 기밀 제출, 이르면 2026.09 공모 목표, 공모 목표 밸류 최대 $1T로 보도 — 사상 최대 기술 IPO가 될 전망입니다. 함정: 2026 Q1에만 $3.7B를 소각해 연간 운영 적자 $15B+ 수준입니다. $852B는 현재 수익성이 아니라 '2030년 매출 $280B 달성 시나리오'에 베팅한 가격입니다. Anthropic의 추격($965B·ARR $47B)이 심상치 않고, Microsoft와의 독점 파트너십도 IPO를 계기로 재편됩니다 — 이것이 IPO 이후 밸류에이션의 최대 불확실성입니다.", nav: "native", keywords: ["openai", "ipo", "밸류", "852", "s-1", "상장", "적자", "122"] },
