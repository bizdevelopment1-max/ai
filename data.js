...
window.DASH = (function () {
  ...
  const ARTICLES = [
    // ── AI Native ──
    { date: "2026-06-30", co: "Anthropic", cat: "native", source: "Anthropic / TNW", title: "Anthropic, Claude Sonnet 5 출시 — 역대 최고 에이전트 Sonnet·인트로 가격 $2/$10", summary: "· Claude Sonnet 5 출시(06.30) — 1M 컨텍스트·에이전트 특화, claude.ai Free·Pro 기본 모델로 즉시 적용\n· Terminal-Bench 2.1 80.4%로 Opus 4.8(74.6%) 상회·GDPval-AA v2 1,618 Elo — 인트로 가격 $2/$10(8월 말까지, 이후 $3/$15)\n· 단말 관점: Opus급 성능을 중급가로 — 에이전트 상용 배포의 비용 장벽 완화", tag: "Product", url: "https://www.anthropic.com/news/claude-sonnet-5" },
