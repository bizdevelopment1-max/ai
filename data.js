...
window.DASH = (function () {
  ...
  const COMPANIES = [
    // ── native ──
    {
      ...
      valuation: "$730B", valAsof: "26.02", metric: "연환산 매출", value: "$25B+", metricAsof: "26.02",
      funding: "$110B 신규(2026.02)", trend: 120, trendBasis: "매출 연환산 $25B+ (회사·Reuters)",
      note: "[회사 발표] GPT-4o·o3, ChatGPT, Sora. 2026.02 공식 자금조달: $110B 신규 투자·$730B pre-money(post ~$840B). [보도] IPO 공모 목표 밸류는 ~$840B에서 최대 $1T까지 상향 보도(2026.06). [회사 발표] ChatGPT 주간 활성 사용자 900M+. [회사·Reuters] 연환산 매출 $25B+(2026.02 말, 월 매출 ~$2B). [업계 추정] $35B 등 그 이상 수치는 외부 추정. [회사] 2026.06.24 Jalapeño(Broadcom 협력) 추론 전용 ASIC 공개 — 9개월 개발·성능/와트 현 최첨단 대비 50% 우위 주장(자체 발표)·2026말 초도 배포·2027 램프업. [ONCD·OSTP] 2026.06.25 GPT-5.6 배포 제한 요청·초도 20개 파트너(Amazon Bedrock 포함) 한정·정부 케이스별 심사. [Reuters/NYT] Altman '$1T 이하 IPO 없다' — 2027년 상장 유력(2026.09 목표 사실상 후퇴).",
      vp: "최고 성능 멀티모달 모델과 9억 규모의 소비자 접점을 동시에 보유한 유일한 사업자. API·구독·엔터프라이즈로 매출 다각화.",
      direction: "범용 인공지능(AGI) 지향 + 대규모 컴퓨트 자금 조달. 추론 모델(o-시리즈)과 에이전트로 확장.",
      sources: ["[회사 발표] $110B 신규·$730B pre-money (OpenAI 2026.02.27)", "[회사 발표] 주간 활성 사용자 900M+ (OpenAI 2026.02)", "[Reuters] 연환산 매출 $25B 초과 (2026.02 말)", "[업계 추정] ARR ~$35B (Gerstner 인용) — 회사 확인 아님"],
      url: "https://openai.com",
    },
    {
      cat: "native", name: "Anthropic", domain: "anthropic.com", unit: "파운데이션 모델·안전성",
      valuation: "$965B", valAsof: "26.05", metric: "연환산 매출", value: "$30B+", metricAsof: "26.04",
      funding: "Series H $65B(2026.05)", trend: 140, trendBasis: "밸류 $380B→$965B, 매출 $30B+",
      note: "[회사 발표] Claude Opus/Sonnet/Haiku, Constitutional AI. 2026.05.28 Series H $65B 조달·$965B post-money(직전 2026.02 Series G $380B). [회사 발표] 2026.04.07 ARR $30B 공식 발표(단, OpenAI는 AWS·Google 파트너십 수익 인식 방식 차이로 실질 ~$22B라 반박 — $22B~$30B 논쟁). [회사 발표] Amazon은 기존 $8B 외 즉시 $5B 투자, 향후 최대 $20B 추가 가능(2026.04.20) — '기존 $8B+즉시 $5B(추가 최대 $20B 가능) 투자 완료'는 부정확. AWS 10년 $100B+ 약정. [보도] 2026.06 Google DeepMind 인재 대거 영입: John Jumper(AlphaFold 공동창시자·2024 노벨화학상)·Jonas Adler·Alexander Pritzel 합류 — 프런티어 연구 역량 대폭 강화. [CNBC/Bloomberg 보도] 2026.06.24 Alibaba 연계 25,000개 가짜 계정·2,880만 Claude 대화(2026.04.22~06.05)로 역대 최대 AI 증류 공격 — Claude Fable Preview 코딩·추론·사이버보안 능력 → Qwen 훈련 전용. Anthropic, 백악관·미 상원에 서한 제출(중국 정부 공모 의혹). [보도] 2026.06.12 수출 통제 지시에 따라 Fable 5·Mythos 5 외국인 접근 전면 차단 후, 2026.06.26 상무부 서한으로 100개+ 미국 기업·연방기관에 Mythos 5 접근 부분 허용(Lutnick 장관 서명).",
      vp: "Constitutional AI 기반 신뢰·안전성으로 금융·의료·법률 등 규제 산업 엔터프라이즈에서 선호. 코딩 에이전트 성능 최상위.",
      direction: "안전성 연구와 상업화의 균형. Amazon·Google 클라우드 파트너십으로 컴퓨트 확보, 엔터프라이즈 침투 가속.",
      sources: ["[회사 발표] Series H $65B·$965B post-money (Anthropic 2026.05.28)", "[회사 발표] Series G $380B (2026.02)", "[Reuters] 연환산 매출 $30B+ (2026.04)", "[회사 발표] Amazon 즉시 $5B + 향후 최대 $20B(기존 $8B 별도) (2026.04.20)"],
    ...
    },
    {
      ...
      note: "[회사 발표] Gemini 3.x, AlphaFold, Gemma — Alphabet의 AI 연구 조직. Google I/O 2026에서 Sundar Pichai가 Gemini 앱 MAU 900M+ 돌파 공식 발표. Gemini 3 멀티모달 최고 성능권, 100만 토큰 컨텍스트. AlphaFold로 노벨화학상 수상. 검색·워크스페이스·안드로이드에 Gemini 전면 통합. [보도] 2026.06.18~24 핵심 인재 이탈: Noam Shazeer(Transformer 공동 저자·VP Eng)→OpenAI, John Jumper(AlphaFold 공동창시자·2024 노벨상·VP Fellow)·Jonas Adler·Alexander Pritzel→Anthropic — 6일간 시총 $2,690억 증발(-11%), Q1 2026 FCF -47%(YoY)·CapEx 가이던스 $1,800억~$1,900억. [회사 발표] 2026.06 Gemini 3.5 Flash에 네이티브 Computer Use 기능 내장 — OSWorld-Verified 78.4점(Claude Sonnet 4.6 동률), GPT-5.5 대비 약 3배 저렴, 프롬프트 인젝션 방지 적대적 학습 포함.",
      ...
      sources: ["[회사 발표] Gemini 앱 MAU 900M+ (Google I/O 2026, Pichai)", "[회사 발표] Gemini 3 출시 (Google I/O '26.5)", "AlphaFold 노벨화학상 2024"],
    ...
    },
    {
      ...
      funding: "첫 외부 라운드 완료", trend: 50, trendBasis: "효율 혁신·첫 외부 투자",
      note: "DeepSeek-V3, R1 — 중국 최대 AI 연구소. 2026.06.16 첫 외부 라운드 완료 — CNY 50B+(≈$7.4B), 밸류 $52B~$59B(중국 국유 빅펀드 주도, TrendForce·Reuters·Bloomberg 동시 확인). 외부 투자자 5년 락업·의결권 없음, 국가 AI 펀드(빅펀드)만 의결권 — 사실상 국가 통제형 구조로 美 기업 참여 불가. '노 포칭(no-poaching)' 조항으로 투자자의 직원 채용 금지. R1·V3가 GPT-4급 성능을 약 1/10 비용으로 구현해 'AI 비용 혁명(Sputnik Moment)' 촉발.",
      vp: "압도적 비용 효율과 오픈 가중치 배포로 빠른 채택. AI 인프라 비용 패러다임 전환의 상징.",
      direction: "효율 중심 모델 + 오픈 생태계. 다만 국가펀드 단독 의결권·수출 규제 등 지정학 변수에 노출.",
      sources: ["첫 외부 라운드 완료 CNY 50B+(≈$7.4B)·밸류 $52B~$59B (TrendForce/Reuters/Bloomberg '26.6.16)", "외부 투자자 5년 락업·의결권 없음·국가펀드 단독 의결권·노 포칭 조항", "R1·V3 1/10 비용 GPT-4급 성능 (Reuters)"],
    ...
    // ── bigtech ──
    {
      ...
      note: "[회사 발표] Apple Intelligence는 온디바이스 처리와 Private Cloud Compute(PCC)를 결합한 하이브리드 아키텍처. 단순 '기기 내 추론'이 아니라, 무거운 작업은 무기명 PCC로 처리하고 민감정보는 기기 밖으로 내보내지 않음. WWDC26에서 Foundation Models 프레임워크가 온디바이스 모델·서버 모델·제3자 LLM 제공자까지 연결하는 개발자 경로를 제공한다고 발표.",
      ...
      sources: ["[회사 발표] 온디바이스 + Private Cloud Compute 하이브리드 (Apple 보안 문서)", "[회사 발표] Foundation Models 프레임워크 — 온디바이스/서버/제3자 모델 지원 (WWDC26)"],
    ...
    },
    {
      ...
      note: "[회사 발표] Bedrock, Alexa+, Trainium 칩 — AWS Bedrock 멀티모델 호스팅. 2026.04.20 Anthropic에 즉시 $5B 투자 + 향후 최대 $20B 추가 가능(기존 $8B 별도)·AWS $100B 약정. 2026.02 OpenAI $50B 투자+$100B 클라우드 약정과 함께 '양쪽 베팅(two-horse)' 전략. Trainium2로 NVIDIA 의존도 저감. ($14B AWS AI ARR은 [업계 추정])",
      ...
      sources: ["[회사 발표] Anthropic 즉시 $5B + 최대 $20B 추가(기존 $8B 별도) (2026.04.20)", "[회사 발표] OpenAI $50B 투자+$100B AWS 약정 (2026.02)", "[업계 추정] AWS AI 서비스 ARR ~$14B (2026E)"],
    ...
    },
    {
      ...
      funding: "상장 (NVDA)", trend: 56, trendBasis: "FY26 연 $215.9B · 최신 분기 $81.6B",
      note: "[회사 발표] H100/B200 GPU, CUDA — AI 학습/추론 GPU 시장 80%+ 점유. 최신 공개 분기는 FY2027 1Q 매출 $81.6B(2026.05 발표). FY2026 연매출 $215.9B(+65% YoY) — Q4 FY2026 $68.1B(+73%)·DC $62.3B(+75%) 포함, 직전 FY2025 연 $130.5B와 구분 필요. [업계 추정] B200 출하량은 외부 추정치. 개발자 생태계는 NVIDIA Developer Program 7.5M+ / CUDA-X 1M+ developers(공식) — '400M 개발자'는 근거 없음.",
      ...
      sources: ["[회사 발표] FY2027 1Q 매출 $81.6B (NVIDIA 2026.05)", "[회사 발표] FY2026 연매출 $215.9B · FY2025 $130.5B (구분)", "[회사 발표] NVIDIA Developer Program 7.5M+ / CUDA-X 1M+ developers", "[업계 추정] B200 연 출하량(외부 추정)"],
      url: "https://www.nvidia.com",
    },
    {
      cat: "bigtech", name: "Meta AI", domain: "ai.meta.com", unit: "오픈소스 LLM",
      valuation: "$1.7T", valAsof: "26.06", metric: "Meta AI 제품 MAU", value: "1B+", metricAsof: "26.04",
      funding: "상장 (META)", trend: 35, trendBasis: "Meta AI 제품 MAU 1B+",
      note: "[회사 발표] Llama 4, 오픈 가중치 LLM 리더. Meta AI 어시스턴트(제품) monthly users 1B+ (Meta 공식). 별개로 페이스북·인스타·왓츠앱 앱군 도달(family app exposure)은 30억+ 규모 — 이는 제품 MAU와 다른 지표이므로 분리 표기. 연간 AI 인프라 투자 $65B+.",
      vp: "가장 넓은 오픈소스 분포 + 앱군 30억 도달 유통망. 무료 모델로 생태계를 키우고 AI 광고로 수익화.",
      direction: "오픈 가중치 Llama로 표준 장악 + 광고 최적화 수익. 슈퍼인텔리전스 랩으로 프런티어 투자.",
      sources: ["[회사 발표] Meta AI 제품 monthly users 1B+ (Meta 뉴스룸)", "[구분 지표] 앱군 도달(family app exposure) 30억+ — 제품 MAU 아님", "Llama 4 오픈 가중치 배포 · AI 인프라 투자 $65B+"],
    ...
    // ── startup ──
    {
      ...
      valuation: "$22.6B~23B", valAsof: "26.01", metric: "ARR", value: "$450M~500M", metricAsof: "26.04",
      funding: "Series E-6", trend: 50, trendBasis: "ARR 1개월 +50%",
      note: "AI 검색·답변 엔진 + Comet AI 브라우저. 2026.01.09 Series E-6 완료로 밸류 $22.6B(누적 조달 ~$1.72B). ARR $450M~$500M(Sacra 2026.04 연환산 $500M 돌파), 연 $656M 목표. Comet 전 세계 무료 공개(2025.07 출시→2025.10 무료화→2026.03 iOS)로 크롬과 정면 충돌. 출처 명시 답변으로 신뢰도 차별화.",
      vp: "출처를 명시하는 답변 엔진 + 자율 에이전트 브라우저(Comet)로 탐색·구매까지 대행.",
      direction: "검색을 넘어 에이전틱 브라우징·커머스로 확장. 광고/구독 하이브리드 수익화.",
      sources: ["Series E-6 밸류 $22.6B·누적 조달 ~$1.72B (Startup Riders '26.1)", "ARR $450M~$500M (Sacra '26.4 $500M 연환산)", "Comet 전 세계 무료 공개·연 $656M 목표"],
      url: "https://www.perplexity.ai",
    },
    {
      cat: "startup", name: "Mistral AI", domain: "mistral.ai", unit: "유럽 파운데이션 모델",
      valuation: "$23B", valAsof: "26.06", metric: "ARR", value: "$400M+", metricAsof: "26.01",
      funding: "€20B 밸류 협의", trend: 100, trendBasis: "밸류 €11.7B→€20B (2배)",
      note: "프랑스 기반 AI 스타트업. 2026.06 밸류 €20B(약 $23.2B) 신규 €3B 라운드 협의 중(직전 €11.7B≈$13.5B, 2025.09 ASML·NVIDIA·a16z 주도 대비 2배) — 단, CNBC 기준 확정 밸류는 $13.8B로 협의 라운드와 구분. ARR $400M+(2026.01), 연말 $1B 목표. 파리 데이터센터(13,800 NVIDIA 칩) $830M 부채 조달. Le Chat·Mistral Large. 유럽 AI 주권의 상징.",
      vp: "유럽 규제 호환성·데이터 주권 + 효율적 오픈 모델. EU 공공·산업 고객 접근성.",
      direction: "유럽 주권 AI 포지셔닝 + 자체 컴퓨트 확보 + 엔터프라이즈 커스텀 모델.",
      sources: ["€20B(≈$23.2B) €3B 라운드 협의 (Bloomberg/TechCrunch '26.6.11)", "확정 밸류 $13.8B·총 조달 $3.1B (CNBC Disruptor 50 '26.5)", "ARR $400M+ '26.1·연말 $1B 목표·파리 DC $830M 조달"],
    ...
    },
    {
      ...
      note: "기업용·소버린 AI 특화. 표기 수치는 2025년 기준(ARR $240M·밸류 $5.5B, 2025.07) — 일부 소스는 2차 거래 기반 $9.2B(2024.07 Series F 이후)로 기재하나 IPO 준비 중 공식 수치 미공개로 업데이트 대기. 2026.05 Command A+ 오픈소스·North Mini Code 출시. Oracle·Salesforce·SAP 파트너십. IPO Readiness 76/100(TechStackIPO '26.5).",
      vp: "엔터프라이즈 데이터 보안·소버린(주권) 배포와 RAG 최적화 모델.",
      direction: "규제·보안 민감 산업 + 국가 소버린 AI 타깃, IPO 추진.",
      sources: ["ARR $240M (CNBC '26.2) · 2차 거래 밸류 $9.2B 설", "Command A+ 오픈소스 (2026.5)", "IPO Readiness 76/100 (TechStackIPO '26.5)"],
    ...
    },
    {
      ...
      valuation: "$29B", valAsof: "25.06", metric: "국방 계약", value: "$500M", metricAsof: "26.05",
      funding: "Meta $14.3B 투자", trend: 30, trendBasis: "국방 계약 5배 확대",
      note: "AI 학습 데이터·RLHF·모델 평가 플랫폼. 2025.06 Meta $14.3B 투자로 49% 비의결권 지분 취득 — 밸류 ~$29B로 급등(Meta 역대 2번째 규모 딜). 창업자 CEO Alexandr Wang은 Meta AGI 팀 합류, 임시 CEO Jason Droege 선임. 2026.05 미 국방부 $500M OTA 계약(8개월 만에 $100M→$500M, 5배). 단, Meta 투자 후 OpenAI·Anthropic 데이터 라벨링 고객 이탈 리스크 부각.",
      vp: "프런티어 모델 학습용 고품질 라벨·평가 데이터 + 정부(국방) 의사결정 레이어.",
      direction: "RLHF·평가·국방 AI로 확장. 데이터 신뢰성·평가 표준화.",
      sources: ["Meta $14.3B 투자·49% 비의결권·밸류 ~$29B (2025.06 완료)", "국방부 $500M OTA 계약 (Bloomberg '26.5)", "CEO Wang→Meta·임시 CEO Jason Droege"],
      url: "https://scale.com",
    },
    {
      cat: "startup", name: "Runway", domain: "runwayml.com", unit: "비디오 생성 AI",
      valuation: "$5.3B", valAsof: "26.02", metric: "제품", value: "Gen-4", metricAsof: "26.05",
      funding: "Series E $315M", trend: 25, trendBasis: "밸류 $3.3B→$5.3B (2배)",
      note: "비디오 생성 AI 선도. 2026.02 Series E $315M(General Atlantic 주도)로 밸류 $5.3B(직전 $3.3B 대비 약 2배), NVIDIA·Adobe Ventures·AMD Ventures·Fidelity 참여. 2026.05 Gen-4 출시(네이티브 오디오·물리 엔진), 2026.12 Gen-4.5 예정(멀티샷·캐릭터 일관성). 비디오를 넘어 '월드 모델'(물리 엔진·로보틱스·게임 월드)로 전략 피벗. Adobe Firefly 멀티이어 파트너십.",
      vp: "전문가급 영상+오디오 생성 품질과 크리에이티브 워크플로우 도구.",
      direction: "영상·오디오에서 '월드 모델'로 확장 + Adobe 파트너십으로 제작 시장 침투.",
      sources: ["Series E $315M·밸류 $5.3B (TechCrunch/Bloomberg '26.2)", "Gen-4 출시 '26.5 · Gen-4.5 '26.12 예정", "월드 모델 피벗 · Adobe Firefly 파트너십"],
    ...
    },
    {
      ...
      valuation: "$11B", valAsof: "26.02", metric: "ARR", value: "$500M", metricAsof: "26.04",
      funding: "Series D $500M", trend: 233, trendBasis: "밸류 $3.3B→$11B (3배+)",
      note: "AI 음성 생성·TTS 시장 선도. 2026.02 Series D $500M로 밸류 $11B(1년 전 $3.3B 대비 3배+), Sequoia 주도·a16z·ICONIQ·Lightspeed 참여. ARR $500M 돌파(2026.04) — 100M→200M→330M→500M 압축 가속, Q1 2026만 +$100M 순증. ElevenAgents(엔터프라이즈 음성 에이전트)로 풀 오디오 플랫폼 전환. 고객 Deutsche Telekom·Square·Revolut.",
      vp: "자연스러운 다국어 음성 합성 품질과 개발자 친화 API. 콘텐츠 제작 파이프라인 표준화.",
      direction: "음성 에이전트·더빙·실시간 대화로 확장. IPO 옵션 검토.",
      sources: ["Series D $500M, 밸류 $11B (CNBC / Reuters '26.2.4)", "ARR $500M 돌파 (Sacra '26.4) · Q1 +$100M 순증", "ElevenAgents 엔터프라이즈 전환"],
    ...
    },
    {
      ...
      note: "법률 전문 AI 에이전트 — 버티컬 AI 리더. 2026.03.25 Series C $200M로 밸류 $11B(GIC·Sequoia 공동 리드, a16z·Coatue·Kleiner Perkins 참여). ARR $190M(5개월 만에 $100M→$190M, +90%). 전 세계 1,300개+ 법률 조직·60개국+, AmLaw 100 과반수 고객. 25,000+ 맞춤형 에이전트 운영, 세무·컴플라이언스로 확장. 총 누적 조달 $1.2B+.",
      vp: "법률 워크플로우에 특화된 도메인 데이터·에이전트로 대형 로펌의 신뢰 확보.",
      direction: "법률 외 전문서비스(세무·컴플라이언스)로 확장. 버티컬 에이전트 섹터 지표 기업.",
      sources: ["Series C $200M, 밸류 $11B (2026.03.25 GIC·Sequoia)", "ARR $190M·1,300개+ 조직 (AgentMarketCap '26.4)", "총 조달 $1.2B+ · 25,000+ 에이전트"],
    ...
    },
    {
      ...
      valuation: "$15.8B", valAsof: "26.05", metric: "ARR", value: "$150M", metricAsof: "26.02",
      funding: "Series E $950M", trend: 100, trendBasis: "밸류 $10B→$15.8B 점프",
      note: "고객 대면 AI 에이전트 플랫폼 — 기업 고객 서비스 전문. 2026.05.04 Series E $950M로 밸류 $15.8B(Tiger Global·GV 주도, Benchmark·Sequoia·Greenoaks 참여). ARR $150M(창업 2024.02 이후 8분기 만에 — 섹터 최고 성장 궤도), 총 조달 $1B+. Fortune 50의 40%+ 고객화. 공동창업 Bret Taylor(전 Salesforce 공동 CEO)의 브랜드 신뢰가 핵심 레버.",
    ...
    {
      cat: "startup", name: "General Intuition", domain: "generalintuition.ai", unit: "게임 데이터 기반 AI 에이전트 훈련",
      valuation: "$2.3B", valAsof: "26.06", metric: "학습 데이터", value: "10억+ 시간 게임 클립", metricAsof: "26.06",
      funding: "Series A $320M (2026.06)", trend: 100, trendBasis: "게임→실세계 에이전트 전환 테제",
      note: "비디오게임 플레이 데이터로 AI 에이전트를 훈련하는 스타트업. 2026.06.25 Series A $320M·밸류 $2.3B — Khosla Ventures 리드, General Catalyst·Jeff Bezos·Eric Schmidt 참여. Medal(월 1,700만 MAU) 게임 클립 10억 시간+ 데이터셋으로 Action Foundation Model 훈련. 게임 환경에서 물리적 세계 추론 능력을 습득시켜 로보틱스·시뮬레이션·방위산업으로 TAM 확장.",
      vp: "게임 플레이의 무한 다양성으로 실세계 에이전트 추론 훈련 — 전통적 로보틱스 데이터 수집 비용 없이.",
      direction: "Action Foundation Model 확장 + 로보틱스·방위산업 배포 + 게임 데이터 파트너십.",
      sources: ["Series A $320M·밸류 $2.3B (TechCrunch '26.06.25)", "Khosla Ventures·Bezos·Schmidt 참여", "Medal 10억 시간+ 게임 클립 데이터셋"],
      url: "https://generalintuition.ai",
    },
  ];
  ...
  const ARTICLES = [
    // ── AI Native ──
    { date: "2026-06-08", co: "OpenAI", cat: "native", source: "Al Jazeera / Reuters", title: "OpenAI, 미국 증시 S-1 공식 제출 — IPO 역사상 최대 규모 예고", summary: "· 2026.06.08 SEC S-1 비밀 제출 확인 · 공모 목표 밸류 ~$840B에서 최대 $1T까지 상향 보도\n· 이르면 2026.09 상장 목표(Reuters)\n· 2026 Q1 운영 손실 $3.7B — 매출 폭증에도 컴퓨트·인건비가 더 빠르게 증가\n· 연환산 매출 $25B+(2026.02 회사·Reuters 확인) · ~$35B 등은 외부 추정", tag: "IPO", url: "https://www.aljazeera.com/economy/2026/6/8/tech-giant-openai-files-for-us-initial-public-offering" },
    ...
    { date: "2026-06-16", pub: "2026-06-16", co: "DeepSeek", cat: "native", source: "TrendForce / Reuters / Bloomberg", title: "DeepSeek, 첫 외부 라운드 완료 — CNY 50B+(≈$7.4B), 밸류 $52B~$59B", summary: "· 첫 외부 라운드 완료 CNY 50B+(≈$7.4B)·밸류 $52B~$59B(국유 빅펀드 주도)\n· 외부 투자자 5년 락업·의결권 없음 · 국가펀드만 의결권(국가 통제형)\n· '노 포칭' 조항 — 투자자의 DeepSeek 직원 채용 금지\n· R1·V3로 GPT-4급 성능을 1/10 비용 구현 — 'Sputnik Moment'", tag: "Funding", url: "https://technode.com/2026/05/07/deepseek-reportedly-seeks-first-funding-round-at-45-billion-valuation/" },
    ...
    { date: "2026-06-11", pub: "2026-06-11", co: "Mistral AI", cat: "startup", source: "Bloomberg / TechCrunch", title: "Mistral AI, €3B 라운드 협의 — 밸류 €20B($23B), 직전 대비 2배", summary: "· 밸류 €20B($23B) 신규 €3B 라운드 협의 개시\n· 직전 €11.7B(≈$13.5B, 2025.09 ASML·NVIDIA 주도) 대비 약 2배\n· 파리 데이터센터(13,800 NVIDIA 칩)·스웨덴 시설 건설\n· EU AI 자주권 기업으로 정부·기업 수요 지속 증가", tag: "Funding", url: "https://www.cnbc.com/2026/03/30/mistral-ai-paris-data-center-cluster-debt-financing.html" },
    { date: "2026-05-20", pub: "2026-05-20", co: "Cohere", cat: "startup", source: "CNBC / Cohere", title: "Cohere, ARR $240M 돌파 + Command A+ 오픈소스 — IPO 준비 본격화", summary: "· 2025년 ARR $240M 달성(목표 $200M 초과), 전 분기 QoQ 50%+\n· Command A+ 오픈소스 출시 — 소버린 엔터프라이즈 AI 모델\n· North Mini Code 개발자용 에이전트 코딩 모델 공개\n· Oracle·Salesforce·SAP 파트너십, CEO IPO '곧' 재확인", tag: "Earnings", url: "https://www.cnbc.com/2026/02/13/ai-startup-cohere-revenue-ipo.html" },
    ...
    { date: "2026-06-24", co: "OpenAI", cat: "native", source: "OpenAI / CNBC", title: "OpenAI × Broadcom, 첫 자체 AI 추론 칩 'Jalapeño' 공개 — 설계 9개월", summary: "· 설계→테이프아웃 9개월(업계 최단) · 성능/와트 현 최첨단 대비 50% 우위 주장(자체 발표)\n· HBM(SK Hynix)·TSMC 파운드리 · 2026말 초도 배포→2027 램프업→2028 H1 전면 가동\n· ChatGPT 서빙 비용 ~$140억 → Jalapeño로 토큰당 추론 비용 구조적 감소 겨냥\n· Broadcom이 OpenAI·Google·Meta·ByteDance 4사 동시 공급 — '칩 킹메이커' 포지션", tag: "Product", url: "https://openai.com/index/openai-broadcom-jalapeno-inference-chip/" },
    { date: "2026-06-25", co: "OpenAI", cat: "native", source: "Axios / Reuters / NYT", title: "트럼프 행정부, GPT-5.6 출시 제한 요청 — 역사상 첫 프런티어 모델 사전 개입", summary: "· ONCD·OSTP가 OpenAI에 GPT-5.6 배포 제한 요청·OpenAI 수용\n· 초도 Amazon Bedrock 포함 20개 파트너 한정·정부 케이스별 접근권 심사\n· Altman: '2~3주 후 출시 희망 — 이게 원하는 장기 모델은 아니다'\n· IPO: Altman '$1T 이하 없다' → Reuters/NYT 2027년 상장 유력(09월 목표 후퇴)", tag: "Regulation", url: "https://www.axios.com/2026/06/25/trump-administration-openai-gpt-model-release" },
    { date: "2026-06-22", pub: "2026-06-22", co: "Google DeepMind", cat: "bigtech", source: "enterprisedna / SignalFire", title: "Alphabet 시총 $2,690억 6일 증발 — AI 인재 이탈, 시장 가격화", summary: "· 06.18~24 핵심 인재 4명 이탈: Shazeer(Transformer 공동 저자)→OpenAI\n· Jumper(AlphaFold·노벨상)·Adler·Pritzel→Anthropic — 6일 -11% 급락\n· SignalFire: DeepMind→Anthropic 이직 확률이 역방향 대비 11배 — 구조적 문화 격차\n· Q1 2026 FCF -47%(YoY)·CapEx 가이던스 $1,800억~$1,900억 동시 노출", tag: "Talent", url: "https://enterprisedna.co/resources/news/alphabet-269-billion-market-cap-ai-talent-exodus-2026/" },
    { date: "2026-06-25", co: "General Intuition", cat: "startup", source: "TechCrunch / The AI Insider", title: "General Intuition $320M Series A, 밸류 $2.3B — 게임 데이터로 실세계 AI 에이전트 훈련", summary: "· Khosla Ventures 리드·General Catalyst·Jeff Bezos·Eric Schmidt 참여\n· Medal 플랫폼 월 MAU 1,700만 게임 클립 10억 시간+ → Action Foundation Model 훈련\n· 비디오게임 물리 환경으로 실세계 에이전트 추론 능력 확보 — 로보틱스·방위 TAM 확장\n· 물리 AI(Physical AI) 학습 인프라의 새로운 경로 제시", tag: "Funding", url: "https://techcrunch.com/2026/06/25/general-intuitions-2-3b-bet-that-video-games-can-train-ai-agents-for-the-real-world/" },
    { date: "2026-06-29", pub: "2026-06-29", co: "", cat: "native", source: "TechTimes / Colorado 주의회", title: "Colorado AI Act, 2027.01.01로 연기 — 미국 첫 소비자 AI 권리 법제화", summary: "· 원래 06.30 시행 예정 → SB 26-189로 2027.01.01로 전면 재작성·연기(2026.05.09 주지사 서명)\n· 핵심 권리 유지: AI 자동결정에 대한 설명 요구·인간 재검토 요청권\n· 민간 소송권 삭제 — 시행은 검찰총장 독점\n· 연방 Great American AI Act(06.04 초안) 통과 시 주법 무력화 가능 — 미통과", tag: "Regulation", url: "https://www.techtimes.com/articles/318002/20260608/colorados-ai-law-takes-effect-june-30-it-gives-you-right-appeal-decision-ai-made-about-you.htm" },
    { date: "2026-06-25", co: "", cat: "bigtech", source: "Reuters / CNBC / Evertiq", title: "Qualcomm, AI 소프트웨어 기업 Modular $3.9B 인수 — Swift 창시자 Chris Lattner 합류", summary: "· Qualcomm이 AI 소프트웨어 인프라 기업 Modular를 $3.9B 주식 교환 방식으로 인수 합의\n· Swift 언어 창시자 Chris Lattner 포함 ~150명 Qualcomm 합류 예정\n· 플랫폼: CPU·GPU·NPU·ASIC 재작성 없이 AI 실행 — CUDA 독점에 소프트웨어 레이어 도전\n· NVIDIA 소프트웨어 생태계 대항마로 Qualcomm AI 인프라 스택 확보", tag: "M&A", url: "https://www.reuters.com" },
    { date: "2026-06-26", co: "OpenAI", cat: "native", source: "Reuters / InsiderFinance", title: "GPT-5.6 세부 공개 — Sol·Terra·Luna 3개 모델 구성, 20개 파트너 한정 배포", summary: "· GPT-5.6은 Sol(코딩·사이버보안 특화)·Terra(균형형)·Luna(빠르고 저렴) 3개 모델로 구성\n· 초도 20개 파트너 한정 배포(Amazon Bedrock 포함) — 정부 케이스별 심사\n· Altman: '이 수준의 정부 접근은 장기적 기본값이 되어선 안 된다'\n· 2~3주 후 확대 배포 희망 — 향후 프런티어 모델 정부 개입 표준화 압력", tag: "Product", url: "https://www.reuters.com" },
    { date: "2026-06-26", co: "Anthropic", cat: "native", source: "CNBC / Reuters", title: "美 상무부 서한, Mythos 5 100개+ 기관에 부분 허용 — Lutnick 장관 서명", summary: "· 미 상무부 서한: Mythos 5 접근을 100개+ 미국 기업·연방기관에 부분 허용\n· 앞서 06.12 수출 통제로 Fable 5·Mythos 5 외국인 접근 전면 차단\n· Lutnick 장관: '신뢰할 수 있는 파트너에 적절한 안전장치 마련됐다'\n· 중요 인프라 운영·방어 조직 대상 — AI 모델 접근권이 국가 안보 자산화", tag: "Regulation", url: "https://www.cnbc.com" },
    { date: "2026-06-27", co: "Google DeepMind", cat: "bigtech", source: "Google / Forbes", title: "Gemini 3.5 Flash, 네이티브 Computer Use 탑재 — OSWorld 78.4점·GPT-5.5 대비 3배 저렴", summary: "· Gemini 3.5 Flash에 네이티브 Computer Use 기능 내장 — 마우스 클릭·폼 입력 자율 수행\n· OSWorld-Verified 78.4점 — Claude Sonnet 4.6과 동률, GPT-5.5 대비 약 3배 저렴\n· 데스크탑·모바일·브라우저 환경 통합 지원 · 프롬프트 인젝션 방지 적대적 학습 포함\n· 가격 경쟁력 + 에이전트 능력 동시 충족 — 엔터프라이즈 확산 속도 가속 전망", tag: "Product", url: "https://deepmind.google" },
    { date: "2026-06-28", co: "Google DeepMind", cat: "bigtech", source: "CNBC / Bloomberg", title: "Google, Meta의 Gemini 사용량 제한 — AI 인프라 공급 병목 심화", summary: "· Google이 Meta의 Gemini AI 모델 사용량 제한 — 컴퓨팅 용량 공급 불가(FT 보도)\n· Meta 일부 내부 AI 프로젝트 지연 · 직원 AI 토큰 효율 향상 권고\n· 다른 Google 고객사도 일부 영향 — AI 인프라 공급 병목이 업계 전반으로 확산\n· 수요 > 공급 구조 심화 — $650B+ CapEx에도 병목 해소 미완", tag: "Analysis", url: "https://www.bloomberg.com" },
    { date: "2026-06-28", co: "Anthropic", cat: "native", source: "Reuters", title: "오스트리아, EU에 Anthropic 유럽 법적 설립 제안 — AI 수출 통제 갈등 가시화", summary: "· 오스트리아가 EU 기술담당 집행위원 Virkkunen에 Anthropic 유럽 내 법적 설립 제안\n· 배경: 미국 수출 통제로 Fable 5·Mythos 5 외국인 접근 차단 → EU 기술 주권 위협\n· Proell 국무장관: '유럽이 주요 혁신으로부터 단절되어선 안 된다'\n· AI 수출 통제가 미·EU 기술 패권 갈등으로 번지는 첫 공식 신호", tag: "Regulation", url: "https://www.reuters.com" },
    { date: "2026-06-25", co: "", cat: "startup", source: "TechCrunch / Reuters", title: "Agility Robotics, SPAC 합병 $2.5B 상장 추진 — 순수 휴머노이드 로봇 미국 첫 공모", summary: "· 이족보행 로봇 Digit 보유 Agility Robotics, Churchill Capital XI와 SPAC 합병 추진\n· 평가액 $2.5B · 예상 조달 $620M+ · 티커 $AGLT 예정\n· 순수 휴머노이드 로봇 기업으로 미국 시장 최초 상장 사례\n· 물류·제조 자동화 타깃 — Physical AI 자본 유입의 공모시장 진입 신호", tag: "IPO", url: "https://techcrunch.com" },
    { date: "2026-06-25", pub: "2026-06-25", co: "OpenAI", cat: "native", source: "NYT / Reuters", title: "OpenAI IPO 2027년으로 연기 검토 — Kalshi 예측시장 발표 확률 59%", summary: "· NYT 보도: OpenAI IPO를 2026년 말 → 2027년으로 연기 검토\n· SpaceX 상장 후 기술주 시장 변동성 확대가 주요 배경\n· Altman: '$1T 평가액 이하로 낮추는 것은 받아들일 수 없다'\n· Kalshi 예측시장: 2027.03.01 이전 IPO 발표 확률 59% 평가", tag: "IPO", url: "https://www.nytimes.com" },
    { date: "2026-06-25", co: "", cat: "startup", source: "The AI Insider / Yahoo Finance", title: "Cerebras Q1 2026 첫 실적 — 매출 $193.4M +94% YoY, 주가 ~20% 급락", summary: "· Cerebras Systems Q1 2026 매출 $193.4M — 전년比 +94% 성장\n· 주가 ~20% 급락 — 연간 총이익률 가이던스 38~41%가 Q1(47%)보다 낮게 제시\n· Feldman CEO: '기존 고객 시스템 임대로 즉시 컴퓨팅 수요 충당하는 일시 전략'\n· 장기 목표 마진 60% — AI 추론 칩 전문 기업 수익성 구조 검증 국면", tag: "Earnings", url: "https://finance.yahoo.com" },
    { date: "2026-06-24", co: "Anthropic", cat: "native", source: "CNBC / Bloomberg", title: "Anthropic, Alibaba가 Claude 역대 최대 증류 공격 실행 주장 — 백악관·상원 서한 제출", summary: "· 2026.04.22~06.05 Alibaba 연계 25,000개 가짜 계정으로 2,880만 Claude 대화 — Claude Fable Preview 능력 추출\n· 목표: 코딩·다단계 추론·사이버보안 능력 → Qwen 모델 훈련 전용 — Anthropic '역대 최대 AI 증류 공격'\n· Anthropic, 백악관·미 상원(Scott·Warren)에 서한 — 중국 정부 공모 의혹·트럼프 행정부 경고 무시 주장\n· '수백억 달러 미국 AI 투자를 지정학적 경쟁자 보조금으로 전용' — Mythos 5 수출 통제의 직접 배경", tag: "Security", url: "https://www.cnbc.com/2026/06/24/anthropic-alibaba-distillation-campaign.html" },
    { date: "2026-06-26", co: "OpenAI", cat: "native", source: "OpenAI / Yahoo Finance Tech", title: "GPT-4.5 ChatGPT 전면 은퇴 — GPT-4 계열 마지막 모델·GPT-5 시대 공식 전환", summary: "· GPT-4.5, 2026.06.26 ChatGPT에서 전면 은퇴 — GPT-4 계열 마지막 모델 · 2026.05.28 공지 후 30일 sunset 완료\n· 기존 대화는 GPT-5.5로 자동 계속 · API는 유지 — ChatGPT 인터페이스 전용 조치\n· o3도 2026.08.26 은퇴 예정 — GPT-5 계열로 전면 전환 로드맵 확정\n· GPT-4 시대 공식 종료 — OpenAI가 처음 ChatGPT를 바꿔놓은 모델 계보 마감", tag: "Product", url: "https://tech.yahoo.com/ai/chatgpt/articles/openai-just-quietly-retired-final-152930749.html" },
    { date: "2026-06-27", co: "", cat: "bigtech", source: "Yahoo Finance / Bloomberg", title: "빅테크 AI 청구서 — 6월 시총 $2.7T 증발·FCF -91%·CapEx $7,250억", summary: "· Mag 7+Broadcom+Oracle 6월 한 달 시총 합산 $2.7T 증발 — AI CapEx 회수 불확실성 본격 반영\n· 하이퍼스케일러 4사 2026 CapEx $7,250억(+77% YoY) · 동기간 FCF 합산 약 -91%(~$160억)\n· 순이익 +25%(~$5,060억) vs 잉여현금 급감 — AI 인프라 비용이 자본시장에 처음 가격화\n· Goldman Sachs '기업 7%만 의미 있는 ROI' 경고 현실화 — CapEx 과잉 vs 수익화 속도 격차 부각", tag: "Market", url: "https://finance.yahoo.com/markets/article/big-techs-27-trillion-ai-bill-comes-due-chart-of-the-day-100000100.html" },
    { date: "2026-06-28", co: "OpenAI", cat: "native", source: "OpenAI", title: "OpenAI, GPT-5.6 Sol Preview 첫 공식 공개 — 코딩·사이버보안 특화 최초 프런티어 공개", summary: "· OpenAI, 2026.06.28 GPT-5.6 Sol Preview 공식 첫 공개 — 정부 협의 후 제한적 출시\n· Sol: 코딩·사이버보안 특화, Terra: 균형형, Luna: 빠르고 저렴 — 3-tier 아키텍처 확정\n· Amazon Bedrock 포함 20개 파트너 한정 · 수 주 내 일반 배포 목표\n· Polymarket: 7월 말 이전 전면 출시 확률 94% — 정부 개입 이후 첫 프런티어 모델 공개 사례로 기록", tag: "Product", url: "https://openai.com/news/" },
  ...
  const REPORTS = [
    ...
    { house: "McKinsey", type: "Survey", date: "2025-11-01", title: "State of AI 2025 — 기업 88% AI 사용하나 2/3는 미완의 엔터프라이즈 스케일", figure: "도입 88% · 스케일 1/3", rating: "Report", url: "https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai",
  ...
  /* ---- Funding / Valuation ($B) ---- */
  const FUNDING = [
    { name: "Anthropic", value: 965, cat: "native", src: "[회사] Series H $65B·$965B post (2026.05.28)" },
    { name: "OpenAI", value: 840, cat: "native", src: "[회사] 2026.02 $730B pre + $110B 신규(post ~$840B)" },
    ...
    { name: "DeepSeek", value: 55, cat: "native", src: "TrendForce/Reuters '26.6 $52B~59B" },
    { name: "Scale AI", value: 29, cat: "startup", src: "Meta $14.3B '25.6 (49% 비의결권) ~$29B" },
    ...
    { name: "Groq", value: 2.8, cat: "startup", src: "Series D $640M·밸류 $2.8B (2024.08, 2026 $650M 추가)" },
    { name: "General Intuition", value: 2.3, cat: "startup", src: "TechCrunch '26.6 Series A $320M·밸류 $2.3B" },
  ];
  ...
  const USERS = [
    { name: "ChatGPT(주간 활성)", value: 900, cat: "native", src: "[회사] OpenAI 2026.02 WAU 900M+" },
    { name: "Gemini 앱(MAU)", value: 900, cat: "bigtech", src: "[회사] Google I/O 2026 MAU 900M+" },
    { name: "Meta AI(제품 MAU)", value: 1000, cat: "bigtech", src: "[회사] Meta AI 제품 1B+ (앱군 도달 30억과 구분)" },
    { name: "X+Grok(합산 도달)", value: 600, cat: "native", src: "[회사] xAI Series E — X+Grok combined reach ~600M (Grok 단독 아님)" },
  ...
  const REVENUE = [
    { name: "NVIDIA (FY26 연)", value: 215.9, cat: "bigtech", src: "[회사] NVIDIA FY2026 연매출 $215.9B (FY25 $130.5B와 구분)" },
    { name: "Microsoft AI (런레이트)", value: 37.0, cat: "bigtech", src: "[회사] Microsoft IR FY26 Q3 — $37B(+123%)" },
    { name: "Anthropic (ARR)", value: 30.0, cat: "native", src: "[회사] ARR $30B 공식(2026.04.07) · OpenAI는 회계 인식 차이로 실질 ~$22B 반박" },
    { name: "OpenAI (연환산)", value: 25.0, cat: "native", src: "[회사·Reuters] 연환산 $25B+ (2026.02)" },
  ...
  const KPIS = [
    ...
    { label: "OpenAI 밸류 (2026.02)", value: "$730B", delta: +120, sub: "[회사] pre-money · $110B 신규(post ~$840B) · 연환산 $25B+", fill: 0.92, src: "OpenAI 공식 2026.02.27" },
    { label: "Anthropic 밸류 (2026.05)", value: "$965B", delta: +154, sub: "[회사] Series H $65B · post-money · 연환산 $30B+", fill: 0.96, src: "Anthropic 공식 2026.05.28" },
    { label: "NVIDIA 매출 (FY27 1Q)", value: "$81.6B", delta: +56, sub: "[회사] 최신 분기 · FY26 연 $215.9B(FY25 $130.5B 구분)", fill: 0.90, src: "NVIDIA IR 2026.05" },
    { label: "Microsoft AI 런레이트", value: "$37B", delta: +123, sub: "[회사] Copilot 2,000만 좌석 · Azure 35% 재가속", fill: 0.78, src: "Microsoft IR FY26 Q3" },
    { label: "ChatGPT 주간 활성 사용자", value: "900M+", delta: +60, sub: "[회사] OpenAI 2026.02 발표", fill: 0.80, src: "OpenAI 공식 2026.02" },
  ];

  /* ---- Insight Cards (9) ---- */
  const INSIGHTS = [
    { title: "OpenAI 하드웨어 직접 진입 — 'AI 네이티브 단말'이 새 경쟁축", desc: "OpenAI가 Jony Ive의 io(인수가 $6.4B)·LoveFrom과 첫 디바이스를 준비 — 화면 없는(스크린리스) 음성·주변(ambient) 중심 기기로, 중독성을 줄이는 'no-screen' 철학이 핵심 · Meta 리얼리티랩스 통신 총괄 Ha Thai 영입(2026.06.18)으로 출시 채비 가속, Foxconn 첫해 4~5천만 대 생산 계획(미국·베트남 제조)·연내 공개 목표나 2027 지연설 — 단말 관점: 모델 1위 기업이 단말까지 수직 통합하면 'AI 비서=별도 기기' 노선이 스마트폰·웨어러블 폼팩터에 정면 도전 — 제조사는 화면형 단말의 차별화 논리를 재정의해야 함", icon: "device", src: "Axios/The Information '26.06, TrendForce" },
    { title: "모델사 '자체 추론칩' 시대 — OpenAI Jalapeño로 NVIDIA 의존 축소", desc: "2026.06.24 OpenAI·Broadcom이 LLM 추론 전용 첫 커스텀 ASIC 'Jalapeño'를 공개 — 설계→테이프아웃 9개월(업계 최단), 성능/와트 현 최첨단 대비 50% 우위 주장(자체 발표·독립 벤치마크 미공개), HBM(SK Hynix)·TSMC 파운드리 · 2026말 초도→2027 램프업→2028 H1 전면 가동, ChatGPT 서빙 비용 ~$140억 → 토큰당 추론 비용 구조적 감소 겨냥 · Broadcom이 OpenAI·Google·Meta·ByteDance 4사 동시 공급 — '칩 킹메이커' 포지션 강화, NVIDIA 추론 시장 점유에 균열 — 단말 관점: 클라우드 추론 원가 하락이 온디바이스/하이브리드 분기점을 좌우", icon: "chip", src: "OpenAI/CNBC '26.06.24" },
    { title: "AI 모델 거버넌스 분수령 — 美 정부, GPT-5.6 출시 첫 사전 제한", desc: "2026.06.25 ONCD·OSTP가 OpenAI에 GPT-5.6 배포 제한 요청·OpenAI 수용 — Amazon Bedrock 포함 초도 20개 파트너 한정·정부 케이스별 심사 · GPT-5.6은 Sol(코딩·사이버보안 특화)·Terra(균형형)·Luna(빠르고 저렴) 3개 모델로 구성(2026.06.26 공개) · Altman: '2~3주 후 출시 희망 — 이게 원하는 장기 모델은 아니다' · 역사상 첫 정부 프런티어 모델 사전 제한 · IPO: Altman '$1T 이하 불가' 입장으로 Reuters/NYT 2027년 상장 유력(2026.09 목표 사실상 후퇴) — 단말 관점: 모델 가용성이 지역·정부 승인 변수와 직결되는 시대 진입 — '모델 출시권'이 곧 사업 리스크", icon: "report", src: "Axios/Reuters/NYT '26.06.25, Reuters/InsiderFinance '26.06.26" },
    { title: "에이전트 커머스 개막 — Visa, ChatGPT에 결제망 직접 연동", desc: "2026.06.10 Visa가 결제망을 ChatGPT에 내장 — AI 에이전트가 카드 연결로 추천부터 결제까지 대행(지출한도·승인단계·승인 가맹점 가드레일, 초기 건별 승인) · Agentic AI가 '대화'를 넘어 '실거래'로 진입한 첫 주요 사례 — 단말 관점: 온디바이스 비서가 결제·커머스 동선을 쥐면 '커머스 수수료'가 새 수익원 — 단, 결제는 고위험이라 승인형 UX·권한 분리가 필수", icon: "spark", src: "Visa Payments Forum '26.06.10, AP/Axios" },
    { title: "AI 어시스턴트 '3파전' 고착 — ChatGPT 첫 50% 이하", desc: "2026.05 ChatGPT AI 어시스턴트 점유율 46.4%로 첫 50% 붕괴(2024.12 65.3%→2025.12 52.8%→2026.05 46.4%) · Gemini 27.7%·Claude 10.3%(반년 새 4배) · 단 ChatGPT MAU는 11.1억으로 1위 유지 — 점유율↓과 절대 사용자↑는 분리 필요 — 단말 비서 파트너 선택이 OpenAI·Google·Anthropic 3파전 구도에서 핵심 변수", icon: "pulse", src: "TechCrunch/Fast Company '26.06.16" },
    { title: "Claude '효율 1위' — MAU 245M·유료 전환율 13%로 ChatGPT 2배", desc: "Sensor Tower 2026 State of AI(2026.06): Claude MAU 245M(+400% YoY 수준)·유료 전환율 13%로 ChatGPT(~6%)의 2배 이상 — 사용자 수는 적어도 '수익화 효율'은 최상위 · ChatGPT MAU 11억+·Gemini 662M(앱 기준)과 모수·방법론 차이 병존 · 어시스턴트 점유율은 ChatGPT 46.4%·Gemini 27.7%·Claude 10.3% — 단말 관점: 단말 비서 파트너는 사용자 규모뿐 아니라 유료 전환·엔터프라이즈 침투 효율로 평가해야 함", icon: "pulse", src: "Sensor Tower 2026 State of AI '26.06" },
    ...
    { title: "AI 상장 슈퍼사이클 — SpaceX·OpenAI·Anthropic 동시 IPO 레이스", desc: "SpaceX가 2026.06.12 SPCX로 그린슈 포함 최종 $85.7B 조달(사상 최대)·시총 $2.1T 데뷔 후 06.16 ~$2.51T로 급등(미 시총 4위권), 4일 뒤 Cursor를 $60B에 인수 · Oppenheimer는 목표주가를 $190→$250(+32%)로 상향 · OpenAI(밸류 $852B·IPO 2027 유력·$1T 이하 불가 Altman 입장·GPT-5.6 정부 개입으로 09월 목표 후퇴)·Anthropic($965B·기밀 제출)도 상장 가세 — AI 자본이 사모에서 공모로 이동하며 밸류 검증 국면 진입", icon: "report", src: "CNBC/Fortune/Reuters '26.06" },
    ...
    { title: "OpenAI vs Anthropic 재무 구조 — IPO 수익성 검증 국면", desc: "두 IPO 후보의 '실제 수익성' 격차가 공모 핵심 변수로 부상 · OpenAI: ARR ~$24B(연환산)·Q1 실매출 $5.7B·Non-GAAP 마진 -122%·현금 $73B+·컴퓨트 약정 $665B·밸류 $852B(IPO 2027 유력) · Anthropic: run-rate $47B(공식)이나 Q1 실매출 추정 $4.8B(연환산 ~$19B)로 간극 큼·Q2 Non-GAAP 흑자 전망·밸류 $965B — 핵심 리스크: 두 회사 모두 GAAP 감사 재무 미공개 상태로 공모 진행, OpenAI는 '매출 $1당 $1.22 손실' 구조적 적자, Anthropic은 run-rate 신빙성 — S-1 공개가 실질 밸류 검증 분수령", icon: "pulse", src: "The Information/Bloomberg '26.06" },
    { title: "AI 코딩 에이전트 '3강' — SpaceX·Cursor 인수로 지형 재편", desc: "SpaceX가 Cursor($60B 인수)로 코딩 AI 시장 진입 — GitHub Copilot(Microsoft)·Claude Code(Anthropic)·Grok Build(xAI/SpaceX) 3강 경쟁 본격화 · Cursor ARR $2B(2026.02 Bloomberg 확인)·~$4B/연말 $6B+는 업계 추정(Oppenheimer), DAU 100만+·Fortune 500의 60%+ 고객 · 인수 위약금 $10B($1.5B 현금+$8.5B 컴퓨트)·Cursor 코드 데이터의 Grok 학습 활용 계획에 프라이버시 논란 — 단말 관점: 자연어→앱 생성이 단말 SW 공급 구조를 바꾸는 변곡점", icon: "spark", src: "CNBC/Reuters '26.06, Oppenheimer" },
    { title: "AI 칩 전쟁 — NVIDIA vs 커스텀 실리콘", desc: "NVIDIA B200이 AI 학습 시장 80%+를 점유하나, Google TPU·Amazon Trainium·Microsoft Maia 등 커스텀 칩이 추격 · DeepSeek의 1/10 비용 모델로 효율이 핵심 변수로 부상 · Qualcomm이 Modular($3.9B) 인수 — Chris Lattner(Swift 창시자) 합류, CPU·GPU·NPU·ASIC 재작성 없이 AI 실행하는 멀티 하드웨어 소프트웨어 스택으로 CUDA 독점에 소프트웨어 레이어 도전 · TIKR 모델 기준 NVDA 목표주가 $486(현 ~$220 대비 +121%, 20% 매출 CAGR 중간 케이스)·Q1 2026 AI VC 펀딩 $18.9B(CB Insights)로 자본 유입 지속", icon: "chip", src: "Goldman Sachs '26.02, TIKR/CB Insights '26, Reuters/CNBC '26.06.25" },
    ...
    { title: "Physical AI — AI가 현실 세계로", desc: "Tesla Optimus Gen 3 제한 생산(2026 여름), Figure AI 공장 배포, Waymo 밸류 $126B · 골드만삭스: 2026년 인간형 로봇 5~10만 대 출하·휴머노이드 TAM 2035E $38B(구 $6B서 6배↑, 단가 $4~6만으로 하락) · Agility Robotics $2.5B SPAC 상장 추진($AGLT 예정) — 순수 휴머노이드 로봇 기업 미국 공모시장 첫 진입 · 물리적 AI 전체(자율주행 포함)는 별도 추정 2035E $1.15T — scope 구분", icon: "chip", src: "Goldman Sachs '26, Pomegra '26, TechCrunch '26.06.25" },
    ...
    { title: "AI 인재 전쟁 가격화 — Alphabet 시총 $2,690억, 6일에 증발", desc: "2026.06.18~24 Google DeepMind 핵심 인재 4명 이탈 — Noam Shazeer(Transformer 공동 저자·VP Eng)→OpenAI, John Jumper(AlphaFold 공동창시자·2024 노벨상·VP Fellow)·Jonas Adler·Alexander Pritzel→Anthropic · 6일 Alphabet 시총 $2,690억 증발(-11%), Q1 FCF -47%(YoY) 동시 노출 · SignalFire: DeepMind→Anthropic 이직 확률이 역방향 대비 11배 — 연구 자율성·GPU 직접 접근권이 연봉보다 강한 인재 자석 · 프런티어 AI 연구자가 시장에서 '가격화 가능 자산'으로 공식화된 첫 사례 — 단말 관점: Anthropic 연구 역량 급증이 Claude 성능 우위로 이어질 변수", icon: "pulse", src: "enterprisedna '26.06.18~24, SignalFire" },
    { title: "AI 모델 증류 공격 — 미·중 AI 기술 갈등의 새 전선", desc: "2026.06.24 Anthropic: Alibaba 연계 세력이 25,000개 가짜 계정·2,880만 Claude 대화(2026.04~06)로 역대 최대 증류 공격 실행 — Claude Fable Preview 코딩·추론·사이버보안 능력을 Qwen 훈련에 전용 · '수백억 달러 미국 AI 투자를 지정학적 경쟁자 보조금으로 전용' — Anthropic, 백악관·미 상원에 서한 · AI 수출 통제(Mythos 5·Fable 5)와 증류 공격 방어가 미국 AI 전략의 핵심 두 축으로 부상 · OpenAI·Google도 동일 위협에 노출 — 프런티어 모델 사용약관 집행·IP 보호가 경쟁력 변수", icon: "report", src: "CNBC/Bloomberg '26.06.24, Tom's Hardware" },
    { title: "빅테크 AI 청구서 — $2.7T 시총 증발·FCF -91%·ROI 불확실성", desc: "2026.06 Mag 7+Broadcom+Oracle 시총 합산 $2.7T 증발 — 하이퍼스케일러 4사 CapEx $7,250억(+77% YoY)·동기간 FCF -91%(~$160억) · 순이익 +25% vs 잉여현금 급감 — AI 인프라 비용이 자본시장에 처음 '청구서'로 제시 · Goldman Sachs '기업 7%만 의미 있는 ROI' 경고 현실화 · Gartner '에이전트 프로젝트 40%+ 2027 취소' · 단말 관점: AI 투자 회수 지연이 온디바이스 AI 수요 우선순위 재편 변수로 부상", icon: "pulse", src: "Yahoo Finance/Bloomberg '26.06.27" },
  ];
  ...
  /* ---- Widget 2: Adoption Funnel (도입은 높지만 가치 실현은 좁아짐) ----
     '도입률 88%'만 보지 말고 pilot→scale→EBIT impact→workflow redesign 단계로 분해. 출처: McKinsey State of AI 2025. */
  const ADOPTION_FUNNEL = [
    { stage: "AI 사용(1개+ 기능)", value: 88, sub: "기업 88%가 최소 1개 기능에서 AI 사용", src: "McKinsey State of AI 2025" },
    { stage: "에이전트 실험(Pilot)", value: 62, sub: "62%가 AI 에이전트 실험 중", src: "McKinsey State of AI 2025" },
    { stage: "스케일 운영(Scale)", value: 23, sub: "23%만 일부 스케일 단계서 agentic AI 운영", src: "McKinsey State of AI 2025" },
    { stage: "EBIT 임팩트 보고", value: 8, sub: "기업 수익(EBIT)에 의미 있는 기여 보고는 소수", src: "McKinsey State of AI 2025(추정 환산)" },
    { stage: "워크플로 재설계", value: 5, sub: "AI 중심으로 업무 흐름을 재설계한 비율은 가장 좁음", src: "McKinsey State of AI 2025(추정 환산)" },
  ];

  /* ---- Widget 3: Fact-Check Layer ----
     핵심 수치마다 grade(A 공식/B 보도/C 추정)·type·검증일·소스를 명시. */
  const FACTCHECK = [
    { item: "NVIDIA FY2026 연매출", value: "$215.9B (+65% YoY)", grade: "A", type: "공식", verified: "2026-06-17", src: "NVIDIA IR (Q4 FY26 $68.1B 포함)" },
    { item: "Anthropic ARR", value: "$30B (반박 시 ~$22B)", grade: "B", type: "공식·논쟁", verified: "2026-06-17", src: "Anthropic 2026.04.07 발표 / OpenAI 회계 반박" },
    { item: "OpenAI 연환산 매출", value: "$25B+ ( ~$35B은 추정)", grade: "A", type: "공식·보도", verified: "2026-06-17", src: "OpenAI·Reuters 2026.02" },
    { item: "OpenAI IPO 목표 밸류", value: "$840B ~ 최대 $1T", grade: "B", type: "보도", verified: "2026-06-17", src: "Guardian·Reuters 2026.06 (목표 상향)" },
    { item: "Gartner 에이전트 내장률", value: "40% by 2026말 (2025 <5%)", grade: "B", type: "전망", verified: "2026-06-17", src: "Gartner / Reuters '25.6 (※'80%'는 오인용)" },
    { item: "agentic AI 지출(2026)", value: "$201.9B (+141% YoY)", grade: "B", type: "전망", verified: "2026-06-17", src: "Gartner '26" },
    { item: "글로벌 AI 시장(2025)", value: "$390.9B → 2026E $539.5B", grade: "B", type: "보고서", verified: "2026-06-17", src: "Grand View Research 최신판 (구판 2024 $279B)" },
    { item: "Grok 사용자 6억", value: "X 플랫폼 포함 도달", grade: "C", type: "추정·주의", verified: "2026-06-17", src: "xAI '26.1 (Grok 단독 사용자와 구분 필요)" },
    { item: "Cohere ARR/밸류", value: "$240M / $5.5B (2025)", grade: "C", type: "구버전", verified: "2025-07", src: "2026 공식 미확인 · 2차 거래 $9.2B 설 — 업데이트 대기" },
    { item: "Anthropic '~$45B 추정'", value: "공식 미확인 → 격하", grade: "C", type: "미확인", verified: "2026-06-17", src: "주류는 $30~35B · $45B는 비주류 추정" },
  ];

  /* ---- Q&A Pairs (Korean) ---- */
  const QA_PAIRS = [
    { q: "OpenAI의 현재 밸류와 IPO 전망은?", a: "OpenAI는 2026.03 라운드로 밸류 $840B(사모 사상 최고)를 기록했고, 2026.06.08 SEC에 S-1을 비밀 제출했습니다. 이후 Altman '$1T 이하 IPO 없다' 입장 확인으로 Reuters/NYT는 2027년 상장이 유력하다고 보도했습니다(2026.09 목표 사실상 후퇴). 추가로 2026.06.25 미 정부(ONCD·OSTP)가 GPT-5.6 출시를 제한 요청해 IPO 시점·밸류에 추가 변수가 됐습니다. 주간 활성 사용자 900M+, 연환산 매출은 $25B+(2026.02 회사·Reuters 확인, 궤적 $6B→$20B→$25B)이며 ~$35B 등 그 이상은 외부 추정입니다. 다만 함정도 있습니다: 2026 Q1에만 $3.7B를 소각해 연 $15B+ 운영 적자 수준입니다. $840B 밸류는 현재 수익성이 아니라 'AI가 OS가 되는 미래'에 베팅한 가격입니다. 모델은 GPT-5(2025.08)→GPT-5.4→GPT-5.5(2026.04)로 빠르게 갱신됩니다.", nav: "native", keywords: ["openai", "ipo", "밸류", "840", "s-1", "상장", "적자", "gpt-5"] },
    ...
    { q: "가장 빠르게 성장하는 AI 스타트업은?", a: "ElevenLabs($11B·음성), Harvey($11B·법률), Sierra($15.8B·고객서비스), Glean($7.2B·기업검색), Databricks($134B·데이터+AI), Mistral($23B·유럽) 등입니다. 수평 LLM에서 산업 전문 '버티컬 AI'로 투자가 이동 중이며, ARR 배수가 최대 67x(Sierra)에 이릅니다. (Cursor는 SpaceX에 $60B로 인수돼 'SpaceX (xAI, Cursor)'로 편입됐습니다.)", nav: "startup", keywords: ["스타트업", "성장", "빠른", "버티컬", "elevenlabs", "harvey"] },
  ...
  return { CATEGORIES, COMPANIES, ARTICLES, REPORTS, MARKET_GROWTH, MARKET_VERTICAL, FUNDING, SHARE, USERS, BAND_PRICE, FUNDING_TREND, AI_DEALS, REVENUE, BIZ_MODELS, KPIS, INSIGHTS, CAP_REL, ADOPTION_FUNNEL, FACTCHECK, QA_PAIRS, APP_MONTHLY, REVENUE_MONTHLY, STOCKS, STOCK_SHARES, attachStockEvents };
})();
