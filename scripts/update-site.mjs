...
const commonPublish = [
  ...
  nodeStep("validate-corporate-entities", "scripts/validate-corporate-entities.mjs"),
  nodeStep("refresh-business-classifications", "scripts/refresh-business-classifications.mjs"),
