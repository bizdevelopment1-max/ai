...
const rules = [
  ...
  { file: "startups.json", tab: "스타트업 분석", maxAge: 10, min: 8, items: d => [...(d.large || []), ...(d.small || [])], soft: true },
  { file: "companies.json", tab: "기업 동향", maxAge: 3, min: 8, items: d => Object.keys(d.companies || {}) },
  { file: "market.json", tab: "AI 신사업 시장", maxAge: 35, min: 15, items: d => d.items || [], soft: true },
